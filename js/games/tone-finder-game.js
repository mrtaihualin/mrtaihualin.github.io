...
var WORD_PARTS = {
  ...
  // ── Lin 2026-07-20: ร่างจากข้อมูล syls[] ใน data/words-data.js ที่ Lin ตรวจผ่านแล้ว (ไม่ได้แต่งใหม่) — รอ Lin ตรวจ vn/vf ก่อน publish ──
  'ป้ายรถเมล์':[{c:'ป',vn:'สระอา',vf:'◌า',f:'ย'},{c:'ร',vn:'สระโอะ (ลดรูป)',vf:'โ◌ะ',f:'ถ'},{c:'ม',vn:'สระเอ',vf:'เ◌',f:''}],
  'ต้นไม้':[{c:'ต',vn:'สระโอะ (ลดรูป)',vf:'โ◌ะ',f:'น'},{c:'ม',vn:'สระไอ (ไม้มลาย)',vf:'ไ◌',f:''}],
  'ภูเขา':[{c:'ภ',vn:'สระอู',vf:'ู',f:''},{c:'ข',vn:'สระเอา',vf:'เ◌า',f:''}],
  'ทะเล':[{c:'ท',vn:'สระอะ',vf:'◌ะ',f:''},{c:'ล',vn:'สระเอ',vf:'เ◌',f:''}],
  'ตรงไป':[{c:'ตร',vn:'สระโอะ (ลดรูป)',vf:'โ◌ะ',f:'ง'},{c:'ป',vn:'สระไอ (ไม้มลาย)',vf:'ไ◌',f:''}],
  'กลางวัน':[{c:'กล',vn:'สระอา',vf:'◌า',f:'ง'},{c:'ว',vn:'สระอะ (ไม้หันอากาศ)',vf:'ั',f:'น'}],
  'กลางคืน':[{c:'กล',vn:'สระอา',vf:'◌า',f:'ง'},{c:'ค',vn:'สระอือ',vf:'ื',f:'น'}],
  'อดีต':[{c:'อ',vn:'สระอะ (ลดรูป)',vf:'◌ะ',f:''},{c:'ด',vn:'สระอี',vf:'ี',f:'ต'}],
  'ทุกวัน':[{c:'ท',vn:'สระอุ',vf:'ุ',f:'ก'},{c:'ว',vn:'สระอะ (ไม้หันอากาศ)',vf:'ั',f:'น'}],
  'นาที':[{c:'น',vn:'สระอา',vf:'◌า',f:''},{c:'ท',vn:'สระอี',vf:'ี',f:''}],
  'ชั่วโมง':[{c:'ช',vn:'สระอัว',vf:'ัว',f:''},{c:'ม',vn:'สระโอ',vf:'โ◌',f:'ง'}],
  'เมื่อกี้':[{c:'ม',vn:'สระเอือ',vf:'เือ',f:''},{c:'ก',vn:'สระอี',vf:'ี',f:''}],
  'เดี๋ยวนี้':[{c:'ด',vn:'สระเอีย',vf:'เีย',f:'ว'},{c:'น',vn:'สระอี',vf:'ี',f:''}],
  'วินาที':[{c:'ว',vn:'สระอิ',vf:'ิ',f:''},{c:'น',vn:'สระอา',vf:'◌า',f:''},{c:'ท',vn:'สระอี',vf:'ี',f:''}],
  'ความรัก':[{c:'คว',vn:'สระอา',vf:'◌า',f:'ม'},{c:'ร',vn:'สระอะ (ไม้หันอากาศ)',vf:'ั',f:'ก'}],
  'ความสุข':[{c:'คว',vn:'สระอา',vf:'◌า',f:'ม'},{c:'ส',vn:'สระอุ',vf:'ุ',f:'ข'}],
  'ความฝัน':[{c:'คว',vn:'สระอา',vf:'◌า',f:'ม'},{c:'ฝ',vn:'สระอะ (ไม้หันอากาศ)',vf:'ั',f:'น'}],
  'ความจริง':[{c:'คว',vn:'สระอา',vf:'◌า',f:'ม'},{c:'จร',vn:'สระอิ',vf:'ิ',f:'ง'}],
  'โอกาส':[{c:'อ',vn:'สระโอ',vf:'โ◌',f:''},{c:'ก',vn:'สระอา',vf:'◌า',f:'ส'}],
  'ปัญหา':[{c:'ป',vn:'สระอะ (ไม้หันอากาศ)',vf:'ั',f:'ญ'},{c:'ห',vn:'สระอา',vf:'◌า',f:''}],
  'เป้าหมาย':[{c:'ป',vn:'สระเอา',vf:'เ◌า',f:''},{c:'ม',vn:'สระอา',vf:'◌า',f:'ย'}],
  'ความคิด':[{c:'คว',vn:'สระอา',vf:'◌า',f:'ม'},{c:'ค',vn:'สระอิ',vf:'ิ',f:'ด'}],
  'แม่น้ำ':[{c:'ม',vn:'สระแอ',vf:'แ◌',f:''},{c:'น',vn:'สระอำ',vf:'◌ำ',f:''}],
  'ดอกไม้':[{c:'ด',vn:'สระออ',vf:'◌อ',f:'ก'},{c:'ม',vn:'สระไอ (ไม้มลาย)',vf:'ไ◌',f:''}],
  'สวนสัตว์':[{c:'ส',vn:'สระอัว',vf:'◌ว',f:'น'},{c:'ส',vn:'สระอะ (ไม้หันอากาศ)',vf:'ั',f:'ต'}],
  'ตะวันออก':[{c:'ต',vn:'สระอะ',vf:'◌ะ',f:''},{c:'ว',vn:'สระอะ (ไม้หันอากาศ)',vf:'ั',f:'น'},{c:'อ',vn:'สระออ',vf:'◌อ',f:'ก'}],
  'ตะวันตก':[{c:'ต',vn:'สระอะ',vf:'◌ะ',f:''},{c:'ว',vn:'สระอะ (ไม้หันอากาศ)',vf:'ั',f:'น'},{c:'ต',vn:'สระโอะ (ลดรูป)',vf:'โ◌ะ',f:'ก'}],
  'ข้างหน้า':[{c:'ข',vn:'สระอา',vf:'◌า',f:'ง'},{c:'น',vn:'สระอา',vf:'◌า',f:''}],
  'ข้างหลัง':[{c:'ข',vn:'สระอา',vf:'◌า',f:'ง'},{c:'ล',vn:'สระอะ (ไม้หันอากาศ)',vf:'ั',f:'ง'}]
};
