...
(function () {
  ...
  // ข้อมูล — เฉพาะ 初級
  // ════════════════════════════════════════════
  // หมายเหตุ: 初級ไม่ได้แปลว่าพยางค์เดียวเสมอ (มีคำ 初級ที่ 2 พยางค์ เช่น "เมนู" "โรงแรม" 83/266 คำ)
  // โปรโตไทป์รอบแรกนี้จำกัดเฉพาะ "初級ที่พยางค์เดียว" ก่อน (183 คำ) — คำ 初級ที่ 2 พยางค์ค่อยเพิ่มด่านรองรับทีหลัง
