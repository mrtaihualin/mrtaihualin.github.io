...
The Current owner source runtime selects the exact union of Paid 189 and this Paid 193 batch: 382 semantic records (`初 369 + 中 13`) on all six game surfaces. Free 200 remains the Guest/Login Free catalog in the same protected `game_words` authority. Identical spelling with a different meaning remains a distinct record by `contentKey`.
...
2. Restore the prior verified `game-content` v43 artifact. This removes the all-six Paid 382 union selector before any row deletion and returns the prior owner-only Tone/Paid 189 behavior.
...
- Paid-382-union Edge source candidate: `66570b391a5fbd9d6633b63696124b5e666cb10709fec550ec7fa07fbd1576d7`
