-- ⚠️⚠️ ไฟล์นี้ไม่ใช่ของล่าสุดแล้ว — ห้ามรัน (เก็บไว้ดูประวัติ) ⚠️⚠️
-- ════════════════════════════════════════════════════════════════════════════
-- นี่คือ student_update_own_request "เวอร์ชันก่อนงาน C1"
-- แยกออกมาจาก supabase/2026-07-26_student-rpc-add-rate-limit.sql เมื่อ 2026-07-31
--
-- ต้นฉบับล่าสุดอยู่ที่: supabase/sql/2026-07-31_cancel_24h_guard_on_update.sql
--
-- ต่างกันตรงไหน: ตัวล่าสุดเพิ่มด่าน "ยกเลิกล่วงหน้า 24 ชม." ตอนแก้คำขอ
--   (เดิมด่านนี้มีแค่ตอนส่งคำขอครั้งแรก นักเรียนจึงเดินอ้อมได้ด้วยการแก้คำขอเดิม
--    ให้ชี้ไปคาบที่ใกล้กว่า — ดูรายละเอียดในไฟล์ล่าสุด)
--
-- รันไฟล์นี้ = ด่าน 24 ชม.ตอนแก้คำขอหายไปเงียบๆ ไม่มี error ไม่มีใครรู้ตัว
