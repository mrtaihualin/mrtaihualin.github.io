...
-- ────────────────────────────────────────────────────────────────────────────
-- student_update_own_request ถูกแก้ต่ออีกรอบเมื่อ 2026-07-26 · ต้นฉบับล่าสุดอยู่ที่:
--     supabase/2026-07-26_student-rpc-add-rate-limit.sql
-- (ไฟล์นั้นเก็บของที่ไฟล์นี้เพิ่ม — ค่า offer_status = 'declined' — ไว้ครบแล้ว ตรวจแล้ว 2026-07-31)
--
-- รันไฟล์นี้ซ้ำจะไม่พังทันที (ช่องรับค่าเท่าเดิม) แต่จะลบยามเฝ้าประตูกันคนไล่เดา token
-- (20 ครั้ง/60 วิ ต่อ IP) ที่เพิ่มเมื่อ 2026-07-26 ทิ้งไปเงียบๆ ไม่มี error
--
