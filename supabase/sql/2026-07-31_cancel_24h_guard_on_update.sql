...
--    student_update_own_request ถูกแก้ต่อ (เพิ่มด่าน "ขอเลื่อนคาบต้องเหลือ 6 ชั่วโมง")
...
--    ✅ ด่าน 24 ชม.ของ "ยกเลิก" ที่ไฟล์นี้เพิ่มไว้ ถูกคัดลอกไปครบทุกบรรทัดในไฟล์ใหม่แล้ว
