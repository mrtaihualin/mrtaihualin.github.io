 ...
 * FILE MAP: storage/recovery → floating editor UI → formatting/links → autosave/status → PDF export/init
   ...
   Lin 2026-07-03 · โหลดไฟล์เดียวจบ: <script defer src="js/acquisition/notes-tool.js"></script>
   ============================================================ */
(function () {
  'use strict';
  ...
  var CSS = ''
    ...
    + '.ntbk-tools{flex-shrink:0;display:flex;flex-wrap:wrap;align-items:center;gap:5px;padding:8px 10px;background:#f3ead2;border-bottom:1px solid #e0d2a8;position:relative;}'
    + '.ntbk-tools button{width:38px;height:38px;padding:0;margin:0;border:1px solid #d8c48f;background:#fff;border-radius:8px;'
    +   'font-family:"Noto Sans TC",sans-serif;font-size:14px;font-weight:700;line-height:1;color:#5a3e10;cursor:pointer;transition:all .12s;'
    +   'display:inline-flex;align-items:center;justify-content:center;flex:0 0 38px;overflow:hidden;box-sizing:border-box;vertical-align:middle;}'
    + '.ntbk-tools button:hover{background:#C8973A;color:#1a1a1a;border-color:#C8973A;}'
    + '.ntbk-tools .sep{width:1px;height:22px;background:#d8c48f;margin:0 2px;align-self:center;flex:0 0 auto;}'
    ...
    + '.ntbk-dd{position:relative;display:inline-flex;align-items:center;justify-content:center;width:38px;height:38px;flex:0 0 38px;}'
    + '.ntbk-dd button{margin:0;}'
