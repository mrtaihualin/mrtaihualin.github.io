...
(function (root, factory) {
  ...
  var GAMES = [
    {
      ...
      routingTitle: '【遊戲】泰語聲調練習室 — 看字猜聲調小遊戲',
    ...
    },
    {
      ...
      routingTitle: '【遊戲】泰語拼讀練習室 — 把音節拼起來讀對每個字',
    ...
    },
    {
      ...
      routingTitle: '【遊戲】泰語打字練習室 — 泰文鍵盤打字小遊戲',
    ...
    },
    {
      ...
      routingTitle: '【遊戲】泰語語序練習室 — 排列詞語順序小遊戲',
    ...
    },
    {
      ...
      routingTitle: '【遊戲】泰語造句練習室（樂高）— 挑詞組句子小遊戲',
  ...
  var ARTICLES = [
    ...
    { id:'a-cant-hear', category:'content', access:'free', title:'在泰國住 30 年，發音就會準嗎？聽得懂不代表你聽得出來', routingTitle:'【文章】住泰國久了發音就會準嗎？發音細節容易被忽略', href:'/blog/cant-hear-guide.html', desc:'住在泰國久了發音不一定準，泰語發音的細微差異很容易被忽略。', keywords:['發音不準','住泰國','聽得懂發音不準'] },
    ...
    { id:'a-lego-guide', category:'content', access:'free', title:'泰語造句好難？「樂高造句練習室」開放免費體驗，一步步組出完整句子', routingTitle:'【文章】泰語造句好難？造句方法介紹', href:'/blog/lego-guide.html', desc:'樂高式造句練習室介紹，像積木一樣挑主語動詞受詞組成句子。', keywords:['造句','樂高','組句子'] },
    { id:'a-output', category:'content', access:'free', title:'背了很多泰語單字卻講不出來？只有 input 沒有 output 的問題', routingTitle:'【文章】背單字卻講不出來：只有輸入沒有輸出的問題', href:'/blog/output-guide.html', desc:'背單字跟會說話是兩件事，怎麼從只有輸入變成真正開口。', keywords:['背單字沒用','講不出來','輸入輸出'] },
    ...
    { id:'a-reading-guide', category:'content', access:'free', title:'泰文怎麼拼讀？「拼讀練習室」開放免費體驗，親手拼出子音母音聲調', routingTitle:'【文章】泰文怎麼拼讀？拼讀方法介紹', href:'/blog/reading-guide.html', desc:'拼讀練習室介紹，親手把單字的零件一個個拼出來。', keywords:['拼讀','子音母音太多','怎麼拼讀'] },
    ...
    { id:'a-theory-01', category:'content', access:'free', title:'泰語單字背了幾百個，為什麼還是講不出來？「記得住」跟「用得出來」是兩種記憶', routingTitle:'【文章】背了很多單字還是講不出來：記憶類型的問題', href:'/blog/theory-01-memorize-vs-use.html', desc:'陳述性記憶還沒轉成程序性記憶的問題。', keywords:['背單字講不出來','記憶類型'] },
    ...
    { id:'a-theory-04', category:'content', access:'free', title:'泰國人聽不懂你講什麼，通常不是錯一個地方——而是好幾個小破口剛好對齊', routingTitle:'【文章】泰國人聽不懂你講話：多個小錯誤疊加的問題', href:'/blog/theory-04-swiss-cheese.html', desc:'起司理論解釋聲調、母音長短、語序、語速多個小錯誤疊加的問題。', keywords:['泰國人聽不懂','多個錯誤疊加'] },
    ...
    { id:'a-theory-13', category:'content', access:'free', title:'單字量明明很大，講話卻常常詞窮？「認得出」跟「叫得出來」是兩種不同的字彙量', routingTitle:'【文章】單字量大卻常詞窮：認得出跟叫得出來是兩種字彙量', href:'/blog/theory-13-receptive-vs-productive.html', desc:'接受性字彙跟產出性字彙本來就不一樣大。', keywords:['詞窮','認得但講不出來'] },
    ...
    { id:'a-theory-21', category:'content', access:'free', title:'背了快 1,000 個泰語單字，聊個簡單話題還是卡住？問題出在「功能詞塊」不是單字量', routingTitle:'【文章】背了很多單字還是不會聊天：功能詞塊的問題', href:'/blog/theory-21-vocab-vs-chat.html', desc:'決定能不能開口聊天的是打招呼、點餐、閒聊的功能詞塊。', keywords:['單字量很大但不會聊天','功能詞塊'] },
    ...
    { id:'a-tone-guide', category:'content', access:'free', title:'泰語聲調怎麼練？「聲調練習室」開放免費體驗，邊玩邊記 5 個聲調', routingTitle:'【文章】泰語聲調怎麼練？聲調練習方法介紹', href:'/blog/tone-guide.html', desc:'聲調練習室介紹，看字猜聲調連對加分。', keywords:['聲調怎麼練','聲調總是搞混'] },
    ...
    { id:'a-typing-guide', category:'content', access:'free', title:'泰文打字怎麼學？「打字練習室」開放免費體驗，教你用泰文鍵盤盲打', routingTitle:'【文章】泰文打字怎麼學？打字方法介紹', href:'/blog/typing-guide.html', desc:'打字練習室介紹，鍵盤已照泰文排好位置。', keywords:['泰文打字怎麼學','泰文鍵盤'] },
    { id:'a-word-order-guide', category:'content', access:'free', title:'泰語語序總是排錯？「語序練習室」開放免費體驗，拖詞塊練出泰式語感', routingTitle:'【文章】泰語語序總是排錯？語序練習方法介紹', href:'/blog/word-order-guide.html', desc:'語序練習室介紹，把打散的詞塊點回正確順序。', keywords:['語序總是排錯','語序練習'] },
