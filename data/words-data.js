...
(function (global) {
  ...
  {word:'อีเมล', readingTH:'อี-เมล', en:'ii-meeo', zh:'電子郵件', level:'初', category:'งาน', syls:[{cons:'อ', vowel:'อี', tone_name:'สามัญ', th:'อี'}, {cons:'ม', vowel:'เอ', final:'ล', tone_name:'สามัญ', th:'เมล'}]},
  ...
  {word:'วันหยุด', readingTH:'วัน-หยุด', en:'wan-yùt', zh:'假日', level:'初', category:'งาน', syls:[{cons:'ว', vowel:'อะ', final:'น', tone_name:'สามัญ', th:'วัน'}, {cons:'ย', lead:'ห', vowel:'อุ', final:'ด', tone_name:'เอก', th:'หยุด'}]},
