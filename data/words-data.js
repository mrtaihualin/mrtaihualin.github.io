...
(function (global) {
  ...
  {word:'เมื่อกี้', readingTH:'เมื่อ-กี้', en:'mʉ̂a-gîi', zh:'剛才', level:'初', category:'เวลา', syls:[{cons:'ม', vowel:'เอือ', tone:'่', tone_name:'โท', th:'เมื่อ'}, {cons:'ก', vowel:'อี', tone:'้', tone_name:'ตรี', th:'กี้'}]}, // ⚠️ กี้ ยืนยันจาก Lin 2026-07-15 ว่าเป็น ตรี(4) — แต่เครื่องคิดจริง (tone-engine.js: อักษรกลาง+ไม้โท=โท เสมอ) + subagent อิสระ + Gemini ตอบตรงกันหมดว่าเป็น โท(3) ถ้าเอาคำนี้เข้า words-data.js จริง ตัวเช็ก mismatch อัตโนมัติ (regression-check-tone.js) จะขึ้น flag คำนี้ทุกรอบ เป็นเรื่องปกติไม่ใช่บั๊ก ให้ข้ามได้
