...
(function (global) {
  ...
  {word:'ญาติ', readingTH:'ยาด', en:'yâat', zh:'親戚', level:'初', category:'นามคน', syls:[{cons:'ญ', consRead:'ย', vowel:'อา', final:'ต', finalDisp:'ติ', finalRead:'ด', tone_name:'โท', th:'ญาติ'}]},
  ...
  {word:'ซุป', readingTH:'ซุบ', en:'súp', zh:'湯', level:'初', category:'นามอาหาร', syls:[{cons:'ซ', vowel:'อุ', final:'ป', finalRead:'บ', tone_name:'ตรี', th:'ซุป'}]},
  ...
  {word:'รถ', readingTH:'รด', en:'rót', zh:'車', level:'初', category:'นามของใช้', syls:[{cons:'ร', vowel:'โอะ', final:'ถ', finalRead:'ด', tone_name:'ตรี', th:'รถ'}]},
  ...
  {word:'ผล', readingTH:'ผน', en:'phǒn', zh:'顆/個', level:'初', category:'ลักษณนาม', syls:[{cons:'ผ', vowel:'โอะ', final:'ล', finalRead:'น', tone_name:'จัตวา', th:'ผล'}]},
  ...
  {word:'โกรธ', readingTH:'โกรด', en:'gròot', zh:'生氣', level:'初', category:'กริยา', syls:[{cons:'ก', cluster:'ร', vowel:'โอ', final:'ธ', finalRead:'ด', tone_name:'เอก', th:'โกรธ'}]},
  ...
  {word:'อาหาร', readingTH:'อา-หาน', en:'aa-hǎan', zh:'食物/料理', level:'中', category:'ร้านอาหาร', syls:[{cons:'อ', vowel:'อา', tone_name:'สามัญ', th:'อา'}, {cons:'ห', vowel:'อา', final:'ร', finalRead:'น', tone_name:'จัตวา', th:'หาร'}]},
  {word:'ร้านอาหาร', readingTH:'ร้าน-อา-หาน', en:'ráan-aa-hǎan', zh:'餐廳', level:'中', category:'ร้านอาหาร', syls:[{cons:'ร', vowel:'อา', tone:'้', final:'น', tone_name:'ตรี', th:'ร้าน'}, {cons:'อ', vowel:'อา', tone_name:'สามัญ', th:'อา'}, {cons:'ห', vowel:'อา', final:'ร', finalRead:'น', tone_name:'จัตวา', th:'หาร'}]},
  ...
  {word:'ใบเสร็จ', readingTH:'ใบ-เส็ด', en:'bai-sèt', zh:'收據/帳單', level:'中', category:'ร้านอาหาร', syls:[{cons:'บ', vowel:'ใอ', tone_name:'สามัญ', th:'ใบ'}, {cons:'ส', cluster:'ร', vowel:'เอะ', final:'จ', finalRead:'ด', tone_name:'เอก', th:'เสร็จ'}]},
  ...
  {word:'รถไฟฟ้า', readingTH:'รด-ไฟ-ฟ้า', en:'rót-fai-fáa', zh:'捷運/地鐵', level:'中', category:'การเดินทาง', syls:[{cons:'ร', vowel:'โอะ', final:'ถ', finalRead:'ด', tone_name:'ตรี', th:'รถ'}, {cons:'ฟ', vowel:'ไอ', tone_name:'สามัญ', th:'ไฟ'}, {cons:'ฟ', vowel:'อา', tone:'้', tone_name:'ตรี', th:'ฟ้า'}]},
  ...
  {word:'เช็คอิน', readingTH:'เช็ก-อิน', en:'chék-in', zh:'辦理入住', level:'中', category:'โรงแรม', syls:[{cons:'ช', vowel:'เอะ', final:'ค', finalRead:'ก', tone_name:'ตรี', th:'เช็ค'}, {cons:'อ', vowel:'อิ', final:'น', tone_name:'สามัญ', th:'อิน'}]},
  {word:'เช็คเอาท์', readingTH:'เช็ค-เอา', en:'chék-áo', zh:'退房', level:'中', category:'โรงแรม', syls:[{cons:'ช', vowel:'เอะ', final:'ค', tone_name:'ตรี', th:'เช็ค'}, {cons:'อ', vowel:'เอา', silent:'ท์', tone_name:'ตรี', th:'เอาท์'}]},
  ...
  {word:'บริษัท', readingTH:'บอ-ริ-สัด', en:'bor-rí-sàt', zh:'公司', level:'中', category:'งาน', syls:[{cons:'บ', vowel:'ออ', tone_name:'สามัญ', th:'บ'}, {cons:'ร', vowel:'อิ', tone_name:'ตรี', th:'ริ'}, {cons:'ษ', consRead:'ส', vowel:'อะ', final:'ท', finalRead:'ด', tone_name:'เอก', th:'ษัท'}]},
  ...
  {word:'สวัสดี', readingTH:'สะ-หวัด-ดี', en:'sà-wàt-dii', zh:'你好/再見', level:'中', category:'ทักทาย/เวลา/แนวคิด', syls:[{cons:'ส', vowel:'อะ', tone_name:'เอก', th:'ส'}, {cons:'ว', lead:'ห', vowel:'อะ', final:'ส', finalRead:'ด', tone_name:'เอก', th:'วัส'}, {cons:'ด', vowel:'อี', tone_name:'สามัญ', th:'ดี'}]},
  {word:'ขอบคุณ', readingTH:'ขอบ-คุน', en:'khòp-khun', zh:'謝謝', level:'中', category:'ทักทาย/เวลา/แนวคิด', syls:[{cons:'ข', vowel:'ออ', final:'บ', tone_name:'เอก', th:'ขอบ'}, {cons:'ค', vowel:'อุ', final:'ณ', finalRead:'น', tone_name:'สามัญ', th:'คุณ'}]},
  {word:'ขอโทษ', readingTH:'ขอ-โทด', en:'khǒr-thôot', zh:'對不起', level:'中', category:'ทักทาย/เวลา/แนวคิด', syls:[{cons:'ข', vowel:'ออ', tone_name:'จัตวา', th:'ขอ'}, {cons:'ท', vowel:'โอ', final:'ษ', finalRead:'ด', tone_name:'โท', th:'โทษ'}]},
  ...
  {word:'ผัดไทย', readingTH:'ผัด-ไทย', en:'phàt-thai', zh:'泰式炒麵', level:'初', category:'ร้านอาหาร', syls:[{cons:'ผ', vowel:'อะ', final:'ด', tone_name:'เอก', th:'ผัด'}, {cons:'ท', vowel:'ไอ', final:'ย', tone_name:'สามัญ', th:'ไทย'}]},
  ...
  {word:'รถเมล์', readingTH:'รด-เม', en:'rót-mee', zh:'公車', level:'中', category:'การเดินทาง', syls:[{cons:'ร', vowel:'โอะ', final:'ถ', finalRead:'ด', tone_name:'ตรี', th:'รถ'}, {cons:'ม', vowel:'เอ', silent:'ล์', tone_name:'สามัญ', th:'เมล์'}]},
  {word:'รถทัวร์', readingTH:'รด-ทัว', en:'rót-thua', zh:'遊覽車', level:'中', category:'การเดินทาง', syls:[{cons:'ร', vowel:'โอะ', final:'ถ', finalRead:'ด', tone_name:'ตรี', th:'รถ'}, {cons:'ท', vowel:'อัว', silent:'ร์', tone_name:'สามัญ', th:'ทัวร์'}]},
  ...
  {word:'สถานี', readingTH:'สะ-ถา-นี', en:'sà-thǎa-nii', zh:'車站', level:'中', category:'การเดินทาง', syls:[{cons:'ส', vowel:'อะ', tone_name:'เอก', th:'ส'}, {cons:'ถ', vowel:'อา', tone_name:'จัตวา', th:'ถา'}, {cons:'น', vowel:'อี', tone_name:'สามัญ', th:'นี'}]},
  ...
  {word:'ตำรวจ', readingTH:'ตำ-หรวด', en:'dtam-rùat', zh:'警察', level:'中', category:'การเดินทาง', syls:[{cons:'ต', vowel:'อำ', tone_name:'สามัญ', th:'ตำ'}, {cons:'ร', lead:'ห', vowel:'อัว', final:'จ', finalRead:'ด', tone_name:'เอก', th:'รวจ'}]},
  {word:'ที่จอดรถ', readingTH:'ที่-จอด-รด', en:'thîi-jòot-rót', zh:'停車場', level:'中', category:'การเดินทาง', syls:[{cons:'ท', vowel:'อี', tone:'่', tone_name:'โท', th:'ที่'}, {cons:'จ', vowel:'ออ', final:'ด', tone_name:'เอก', th:'จอด'}, {cons:'ร', vowel:'โอะ', final:'ถ', finalRead:'ด', tone_name:'ตรี', th:'รถ'}]},
  ...
  {word:'ป้ายรถเมล์', readingTH:'ป้าย-รด-เม', en:'bpâai-rót-mee', zh:'站牌', level:'中', category:'การเดินทาง', syls:[{cons:'ป', vowel:'อา', tone:'้', final:'ย', tone_name:'โท', th:'ป้าย'}, {cons:'ร', vowel:'โอะ', final:'ถ', finalRead:'ด', tone_name:'ตรี', th:'รถ'}, {cons:'ม', vowel:'เอ', silent:'ล์', tone_name:'สามัญ', th:'เมล์'}]},
  ...
  {word:'กุญแจ', readingTH:'กุน-แจ', en:'gun-jae', zh:'鑰匙', level:'中', category:'โรงแรม', syls:[{cons:'ก', vowel:'อุ', final:'ญ', finalRead:'น', tone_name:'สามัญ', th:'กุญ'}, {cons:'จ', vowel:'แอ', tone_name:'สามัญ', th:'แจ'}]},
  ...
  {word:'ห้องอาหาร', readingTH:'ห้อง-อา-หาน', en:'hôong-aa-hǎan', zh:'餐廳', level:'中', category:'โรงแรม', syls:[{cons:'ห', vowel:'ออ', tone:'้', final:'ง', tone_name:'โท', th:'ห้อง'}, {cons:'อ', vowel:'อา', tone_name:'สามัญ', th:'อา'}, {cons:'ห', vowel:'อา', final:'ร', finalRead:'น', tone_name:'จัตวา', th:'หาร'}]},
  ...
  {word:'อาหารเช้า', readingTH:'อา-หาน-เช้า', en:'aa-hǎan-cháo', zh:'早餐', level:'中', category:'โรงแรม', syls:[{cons:'อ', vowel:'อา', tone_name:'สามัญ', th:'อา'}, {cons:'ห', vowel:'อา', final:'ร', finalRead:'น', tone_name:'จัตวา', th:'หาร'}, {cons:'ช', vowel:'เอา', tone:'้', tone_name:'ตรี', th:'เช้า'}]},
  ...
  {word:'โทรศัพท์', readingTH:'โท-ระ-สับ', en:'thoo-rá-sàp', zh:'電話', level:'中', category:'งาน', syls:[{cons:'ท', vowel:'โอ', tone_name:'สามัญ', th:'โทร'}, {cons:'ศ', vowel:'อะ', final:'พ', tone_name:'เอก', th:'ศัพท์'}], readSyls:[{cons:'ท', vowel:'โอ', silent:'ร', tone_name:'สามัญ', th:'โทร'}, {cons:'ร', vowel:'อะ', tone_name:'ตรี', th:'ระ'}, {cons:'ศ', consRead:'ส', vowel:'อะ', final:'พ', finalRead:'บ', silent:'ท์', tone_name:'เอก', th:'ศัพท์'}]}, // Lin 2026-07-14: ยกเลิกพยางค์แทรก — พิมพ์ต้องเป็นตัวสะกดจริงเท่านั้น (โทร+ศัพท์) คำอ่าน 3 พยางค์อยู่ที่ readingTH เท่านั้น
  {word:'เอกสาร', readingTH:'เอก-กะ-สาน', en:'èek-gà-sǎan', zh:'文件', level:'中', category:'งาน', syls:[{cons:'อ', vowel:'เอ', final:'ก', tone_name:'เอก', th:'เอก'}, {cons:'ส', vowel:'อา', final:'ร', tone_name:'จัตวา', th:'สาร'}], readSyls:[{cons:'อ', vowel:'เอ', final:'ก', tone_name:'เอก', th:'เอก'}, {cons:'ก', vowel:'อะ', tone_name:'เอก', th:'กะ'}, {cons:'ส', vowel:'อา', final:'ร', finalRead:'น', tone_name:'จัตวา', th:'สาร'}]}, // Lin 2026-07-14: ยกเลิกพยางค์แทรก — พิมพ์ต้องเป็นตัวสะกดจริงเท่านั้น (เอก+สาร) คำอ่าน 3 พยางค์อยู่ที่ readingTH เท่านั้น
  {word:'สัมภาษณ์', readingTH:'สำ-พาด', en:'sǎm-phâat', zh:'面試', level:'中', category:'งาน', syls:[{cons:'ส', vowel:'อะ', final:'ม', tone_name:'จัตวา', th:'สัม'}, {cons:'ภ', consRead:'พ', vowel:'อา', final:'ษ', finalRead:'ด', silent:'ณ์', tone_name:'โท', th:'ภาษณ์'}]},
  ...
  {word:'ออฟฟิศ', readingTH:'ออบ-ฟิด', en:'óp-fít', zh:'辦公室', level:'中', category:'งาน', syls:[{cons:'อ', vowel:'ออ', final:'ฟ', finalRead:'บ', tone_name:'ตรี', th:'ออฟ'}, {cons:'ฟ', vowel:'อิ', final:'ศ', finalRead:'ด', tone_name:'ตรี', th:'ฟิศ'}]},
  ...
  {word:'นามบัตร', readingTH:'นาม-บัด', en:'naam-bàt', zh:'名片', level:'中', category:'งาน', syls:[{cons:'น', vowel:'อา', final:'ม', tone_name:'สามัญ', th:'นาม'}, {cons:'บ', vowel:'อะ', final:'ต', finalDisp:'ตร', finalRead:'ด', tone_name:'เอก', th:'บัตร'}]},
  ...
  {word:'ของขวัญ', readingTH:'ของ-ขวัน', en:'khǒong-khwǎn', zh:'禮物', level:'中', category:'ช้อปปิ้ง', syls:[{cons:'ข', vowel:'ออ', final:'ง', tone_name:'จัตวา', th:'ของ'}, {cons:'ข', cluster:'ว', vowel:'อะ', final:'ญ', finalRead:'น', tone_name:'จัตวา', th:'ขวัญ'}]},
  ...
  {word:'คุณภาพ', readingTH:'คุน-นะ-พาบ', en:'khun-ná-phâap', zh:'品質', level:'中', category:'ช้อปปิ้ง', syls:[{cons:'ค', vowel:'อุ', final:'ณ', tone_name:'สามัญ', th:'คุณ'}, {cons:'ภ', vowel:'อา', final:'พ', tone_name:'โท', th:'ภาพ'}], readSyls:[{cons:'ค', vowel:'อุ', final:'ณ', finalRead:'น', tone_name:'สามัญ', th:'คุณ'}, {cons:'น', vowel:'อะ', tone_name:'ตรี', th:'นะ'}, {cons:'ภ', consRead:'พ', vowel:'อา', final:'พ', finalRead:'บ', tone_name:'โท', th:'ภาพ'}]}, // Lin 2026-07-14: ยกเลิกพยางค์แทรก — พิมพ์ต้องเป็นตัวสะกดจริงเท่านั้น (คุณ+ภาพ) คำอ่าน 3 พยางค์อยู่ที่ readingTH เท่านั้น
  ...
  {word:'เครื่องสำอาง', readingTH:'เครื่อง-สำ-อาง', en:'khrʉ̂ang-sǎm-aang', zh:'化妝品', level:'中', category:'ช้อปปิ้ง', syls:[{cons:'ค', cluster:'ร', vowel:'เอือ', tone:'่', final:'ง', tone_name:'โท', th:'เครื่อง'}, {cons:'ส', vowel:'อำ', tone_name:'จัตวา', th:'สำ'}, {cons:'อ', vowel:'อา', final:'ง', tone_name:'สามัญ', th:'อาง'}]},
  ...
  {word:'นาฬิกา', readingTH:'นา-ลิ-กา', en:'naa-lí-gaa', zh:'時鐘', level:'中', category:'เวลา', syls:[{cons:'น', vowel:'อา', tone_name:'สามัญ', th:'นา'}, {cons:'ฬ', consRead:'ล', vowel:'อิ', tone_name:'ตรี', th:'ฬิ'}, {cons:'ก', vowel:'อา', tone_name:'สามัญ', th:'กา'}]},
  {word:'อากาศ', readingTH:'อา-กาด', en:'aa-gàat', zh:'天氣', level:'中', category:'ทักทาย/เวลา/แนวคิด', syls:[{cons:'อ', vowel:'อา', tone_name:'สามัญ', th:'อา'}, {cons:'ก', vowel:'อา', final:'ศ', finalRead:'ด', tone_name:'เอก', th:'กาศ'}]},
  {word:'ครอบครัว', readingTH:'ครอบ-ครัว', en:'khrôop-khrua', zh:'家庭', level:'初', category:'ทักทาย/เวลา/แนวคิด', syls:[{cons:'ค', cluster:'ร', vowel:'ออ', final:'บ', tone_name:'โท', th:'ครอบ'}, {cons:'ค', cluster:'ร', vowel:'อัว', tone_name:'สามัญ', th:'ครัว'}]},
  {word:'ภาษา', readingTH:'พา-สา', en:'phaa-sǎa', zh:'語言', level:'中', category:'ทักทาย/เวลา/แนวคิด', syls:[{cons:'ภ', consRead:'พ', vowel:'อา', tone_name:'สามัญ', th:'ภา'}, {cons:'ษ', consRead:'ส', vowel:'อา', tone_name:'จัตวา', th:'ษา'}]},
  {word:'ประเทศ', readingTH:'ประ-เทด', en:'bprà-thêet', zh:'國家', level:'中', category:'ทักทาย/เวลา/แนวคิด', syls:[{cons:'ป', cluster:'ร', vowel:'อะ', tone_name:'เอก', th:'ประ'}, {cons:'ท', vowel:'เอ', final:'ศ', finalRead:'ด', tone_name:'โท', th:'เทศ'}]},
  {word:'เมืองไทย', readingTH:'เมือง-ไทย', en:'mʉang-thai', zh:'泰國', level:'初', category:'แนวคิด', syls:[{cons:'ม', vowel:'เอือ', final:'ง', tone_name:'สามัญ', th:'เมือง'}, {cons:'ท', vowel:'ไอ', final:'ย', tone_name:'สามัญ', th:'ไทย'}]},
  ...
  {word:'ปัจจุบัน', readingTH:'ปัด-จุ-บัน', en:'bpàt-jù-ban', zh:'現在', level:'中', category:'เวลา', syls:[{cons:'ป', vowel:'อะ', final:'จ', finalRead:'ด', tone_name:'เอก', th:'ปัจ'}, {cons:'จ', vowel:'อุ', tone_name:'เอก', th:'จุ'}, {cons:'บ', vowel:'อะ', final:'น', tone_name:'สามัญ', th:'บัน'}]},
  {word:'อนาคต', readingTH:'อะ-นา-คด', en:'à-naa-khót', zh:'未來', level:'中', category:'เวลา', syls:[{cons:'อ', vowel:'อะ', tone_name:'เอก', th:'อ'}, {cons:'น', vowel:'อา', tone_name:'สามัญ', th:'นา'}, {cons:'ค', vowel:'โอะ', final:'ต', finalRead:'ด', tone_name:'ตรี', th:'คต'}]},
  ...
  {word:'อาชีพ', readingTH:'อา-ชีบ', en:'aa-chîip', zh:'職業', level:'中', category:'ทักทาย/เวลา/แนวคิด', syls:[{cons:'อ', vowel:'อา', tone_name:'สามัญ', th:'อา'}, {cons:'ช', vowel:'อี', final:'พ', finalRead:'บ', tone_name:'โท', th:'ชีพ'}]},
  ...
  {word:'น้ำตาล', readingTH:'น้ำ-ตาน', en:'nám-taan', zh:'咖啡色', level:'初', category:'สี', syls:[{cons:'น', vowel:'อำ', tone:'้', tone_name:'ตรี', th:'น้ำ'}, {cons:'ต', vowel:'อา', final:'ล', finalRead:'น', tone_name:'สามัญ', th:'ตาล'}]},
  ...
  {word:'สกปรก', readingTH:'สก-กะ-ปรก', en:'sòk-gà-pròk', zh:'髒', level:'中', category:'คำขยาย', syls:[{cons:'ส', vowel:'โอะ', final:'ก', tone_name:'เอก', th:'สก'}, {cons:'ป', cluster:'ร', vowel:'โอะ', final:'ก', tone_name:'เอก', th:'ปรก'}], readSyls:[{cons:'ส', vowel:'โอะ', final:'ก', tone_name:'เอก', th:'สก'}, {cons:'ก', vowel:'อะ', tone_name:'เอก', th:'กะ'}, {cons:'ป', cluster:'ร', vowel:'โอะ', final:'ก', tone_name:'เอก', th:'ปรก'}]}, // Lin 2026-07-14: ยกเลิกพยางค์แทรก — พิมพ์ต้องเป็นตัวสะกดจริงเท่านั้น (สก+ปรก) คำอ่าน 3 พยางค์อยู่ที่ readingTH เท่านั้น
  ...
  {word:'อดีต', readingTH:'อะ-ดีด', en:'à-dìit', zh:'過去', level:'中', category:'เวลา', syls:[{cons:'อ', vowel:'อะ', tone_name:'เอก', th:'อ'}, {cons:'ด', vowel:'อี', final:'ต', finalRead:'ด', tone_name:'เอก', th:'ดีต'}]}, // readingTH=เสียงจริง(อะ-ดีด) / ตัวสะกดจริงสำหรับพิมพ์ = syls[].th ต่อกัน(อ-ดีต)
  ...
  {word:'นาที', readingTH:'นา-ที', en:'naa-thii', zh:'分鐘', level:'初', category:'เวลา', syls:[{cons:'น', vowel:'อา', tone_name:'สามัญ', th:'นา'}, {cons:'ท', vowel:'อี', tone_name:'สามัญ', th:'ที'}]},
  {word:'ชั่วโมง', readingTH:'ชั่ว-โมง', en:'chûa-moong', zh:'小時', level:'初', category:'เวลา', syls:[{cons:'ช', vowel:'อัว', tone:'่', tone_name:'โท', th:'ชั่ว'}, {cons:'ม', vowel:'โอ', final:'ง', tone_name:'สามัญ', th:'โมง'}]},
  {word:'เมื่อกี้', readingTH:'เมื่อ-กี้', en:'mʉ̂a-gíi', zh:'剛才', level:'初', category:'เวลา', syls:[{cons:'ม', vowel:'เอือ', tone:'่', tone_name:'โท', th:'เมื่อ'}, {cons:'ก', vowel:'อี', tone:'้', tone_name:'ตรี', th:'กี้'}]}, // ⚠️ กี้ ยืนยันจาก Lin 2026-07-15 + ยืนยันซ้ำ 2026-07-31 ว่าเป็น ตรี(4) — แต่เครื่องคิดจริง (tone-engine.js: อักษรกลาง+ไม้โท=โท เสมอ) + subagent อิสระ + Gemini ตอบตรงกันหมดว่าเป็น โท(3) ถ้าเอาคำนี้เข้า words-data.js จริง ตัวเช็ก mismatch อัตโนมัติ (regression-check-tone.js) จะขึ้น flag คำนี้ทุกรอบ เป็นเรื่องปกติไม่ใช่บั๊ก ให้ข้ามได้ (แก้ en จาก gîi(ไม้โท) เป็น gíi(ไม้ตรี) 2026-07-31 ให้ตรงกับ tone_name ที่ Lin ยืนยัน — เดิม en เขียนไม่ตรงกันเอง)
  {word:'เดี๋ยวนี้', readingTH:'เดี๋ยว-นี้', en:'dǐao-níi', zh:'現在/馬上', level:'初', category:'เวลา', syls:[{cons:'ด', vowel:'เอีย', tone:'๋', final:'ว', tone_name:'จัตวา', th:'เดี๋ยว'}, {cons:'น', vowel:'อี', tone:'้', tone_name:'ตรี', th:'นี้'}]},
  ...
  {word:'ความรัก', readingTH:'ความ-รัก', en:'khwaam-rák', zh:'愛', level:'初', category:'แนวคิด', syls:[{cons:'ค', cluster:'ว', vowel:'อา', final:'ม', tone_name:'สามัญ', th:'ความ'}, {cons:'ร', vowel:'อะ', final:'ก', tone_name:'ตรี', th:'รัก'}]},
  {word:'ความสุข', readingTH:'ความ-สุก', en:'khwaam-sùk', zh:'幸福', level:'中', category:'แนวคิด', syls:[{cons:'ค', cluster:'ว', vowel:'อา', final:'ม', tone_name:'สามัญ', th:'ความ'}, {cons:'ส', vowel:'อุ', final:'ข', finalRead:'ก', tone_name:'เอก', th:'สุข'}]}, // readingTH=ความ-สุก (ข→ก ตัวแทนแม่กก) / ตัวสะกดจริง = syls[].th ต่อกัน(ความ-สุข)
  {word:'ความฝัน', readingTH:'ความ-ฝัน', en:'khwaam-fǎn', zh:'夢想', level:'初', category:'แนวคิด', syls:[{cons:'ค', cluster:'ว', vowel:'อา', final:'ม', tone_name:'สามัญ', th:'ความ'}, {cons:'ฝ', vowel:'อะ', final:'น', tone_name:'จัตวา', th:'ฝัน'}]},
  ...
  {word:'โอกาส', readingTH:'โอ-กาด', en:'oo-gàat', zh:'機會', level:'中', category:'แนวคิด', syls:[{cons:'อ', vowel:'โอ', tone_name:'สามัญ', th:'โอ'}, {cons:'ก', vowel:'อา', final:'ส', finalRead:'ด', tone_name:'เอก', th:'กาส'}]}, // readingTH=โอ-กาด (ส→ด ตัวแทนแม่กด) / ตัวสะกดจริง = syls[].th ต่อกัน(โอ-กาส)
  {word:'ปัญหา', readingTH:'ปัน-หา', en:'pan-hǎa', zh:'問題', level:'中', category:'แนวคิด', syls:[{cons:'ป', vowel:'อะ', final:'ญ', finalRead:'น', tone_name:'สามัญ', th:'ปัญ'}, {cons:'ห', vowel:'อา', tone_name:'จัตวา', th:'หา'}]},
  {word:'เป้าหมาย', readingTH:'เป้า-หมาย', en:'bpâo-mǎai', zh:'目標', level:'初', category:'แนวคิด', syls:[{cons:'ป', vowel:'เอา', tone:'้', tone_name:'โท', th:'เป้า'}, {cons:'ม', lead:'ห', vowel:'อา', final:'ย', tone_name:'จัตวา', th:'หมาย'}]},
  {word:'ความคิด', readingTH:'ความ-คิด', en:'khwaam-khít', zh:'想法', level:'初', category:'แนวคิด', syls:[{cons:'ค', cluster:'ว', vowel:'อา', final:'ม', tone_name:'สามัญ', th:'ความ'}, {cons:'ค', vowel:'อิ', final:'ด', tone_name:'ตรี', th:'คิด'}]},
  {word:'แม่น้ำ', readingTH:'แม่-น้ำ', en:'mâe-náam', zh:'河', level:'初', category:'สัตว์/ธรรมชาติ', syls:[{cons:'ม', vowel:'แอ', tone:'่', tone_name:'โท', th:'แม่'}, {cons:'น', vowel:'อำ', tone:'้', tone_name:'ตรี', th:'น้ำ'}]},
  ...
  {word:'สวนสัตว์', readingTH:'สวน-สัด', en:'sǔan-sàt', zh:'動物園', level:'中', category:'สัตว์/ธรรมชาติ', syls:[{cons:'ส', vowel:'อัว', final:'น', tone_name:'จัตวา', th:'สวน'}, {cons:'ส', vowel:'อะ', final:'ต', finalRead:'ด', silent:'ว์', tone_name:'เอก', th:'สัตว์'}]}, // readingTH=สวน-สัด (ตว์→ด ตัวแทนแม่กด, ว์ การันต์ไม่ออกเสียง) / ตัวสะกดจริง = syls[].th ต่อกัน(สวน-สัตว์)
  ...
  // ════════════════════════════════════════════════════════════
  // เพิ่ม 2026-07-30 — ชุดสรรพนาม/บุพบท/สันธาน (53) + ชุดสระใอ/คำยกเว้น (9) รวม 62 คำ
  // ร่างผ่าน /thai-vocab-draft-batch, Lin ตรวจ/แก้ครบทุกฟิลด์แล้ว + เช็ก 2 AI อิสระ (subagent 2 ตัว
  // คนละ context คนละโมเดล) ก่อน publish — ดู reference log 2026-07-30 สำหรับรายละเอียดการแก้/ข้อยกเว้น
  // ════════════════════════════════════════════════════════════
  {word:"เรา", en:"rao", zh:"我們/我（同輩）", level:"初", category:"สรรพนาม", syls:[{cons:"ร", vowel:"เอา", tone_name:"สามัญ", th:"เรา"}]},
  {word:"พวกเรา", readingTH:"พวก-เรา", en:"phûak-rao", zh:"我們（同輩）", level:"初", category:"สรรพนาม", syls:[{cons:"พ", vowel:"อัว", final:"ก", tone_name:"โท", th:"พวก"}, {cons:"ร", vowel:"เอา", tone_name:"สามัญ", th:"เรา"}]},
  {word:"คุณ", readingTH:"คุน", en:"khun", zh:"你/您（正式）", level:"初", category:"สรรพนาม", syls:[{cons:"ค", vowel:"อุ", final:"ณ", tone_name:"สามัญ", th:"คุณ", finalRead:"น"}]},
  {word:"เธอ", en:"thoe", zh:"你（口語）", level:"初", category:"สรรพนาม", syls:[{cons:"ธ", vowel:"เออ", tone_name:"สามัญ", th:"เธอ"}]},
  {word:"ท่าน", en:"thâan", zh:"您（敬語）", level:"初", category:"สรรพนาม", syls:[{cons:"ท", vowel:"อา", tone:"่", final:"น", tone_name:"โท", th:"ท่าน"}]},
  {word:"แก", en:"gae", zh:"你（熟識、隨意）", level:"初", category:"สรรพนาม", syls:[{cons:"ก", vowel:"แอ", tone_name:"สามัญ", th:"แก"}]},
  {word:"พวกคุณ", readingTH:"พวก-คุน", en:"phûak-khun", zh:"你們（正式）", level:"中", category:"สรรพนาม", syls:[{cons:"พ", vowel:"อัว", final:"ก", tone_name:"โท", th:"พวก"}, {cons:"ค", vowel:"อุ", final:"ณ", tone_name:"สามัญ", th:"คุณ", finalRead:"น"}]},
  {word:"มัน", en:"man", zh:"它/他/她（不禮貌）", level:"初", category:"สรรพนาม", syls:[{cons:"ม", vowel:"อะ", final:"น", tone_name:"สามัญ", th:"มัน"}]},
  {word:"พวกเขา", readingTH:"พวก-เขา", en:"phûak-khǎo", zh:"他們/她們", level:"初", category:"สรรพนาม", syls:[{cons:"พ", vowel:"อัว", final:"ก", tone_name:"โท", th:"พวก"}, {cons:"ข", vowel:"เอา", tone_name:"จัตวา", th:"เขา"}]},
  {word:"ตัวเอง", readingTH:"ตัว-เอง", en:"dtua-eeng", zh:"自己", level:"初", category:"สรรพนาม", syls:[{cons:"ต", vowel:"อัว", tone_name:"สามัญ", th:"ตัว"}, {cons:"อ", vowel:"เอ", final:"ง", tone_name:"สามัญ", th:"เอง"}]},
  {word:"นี่", en:"nîi", zh:"這個", level:"初", category:"สรรพนาม", syls:[{cons:"น", vowel:"อี", tone:"่", tone_name:"โท", th:"นี่"}]},
  {word:"นั่น", en:"nân", zh:"那個", level:"初", category:"สรรพนาม", syls:[{cons:"น", vowel:"อะ", tone:"่", final:"น", tone_name:"โท", th:"นั่น"}]},
  {word:"โน่น", en:"nôon", zh:"那個（較遠）", level:"初", category:"สรรพนาม", syls:[{cons:"น", vowel:"โอ", tone:"่", final:"น", tone_name:"โท", th:"โน่น"}]},
  {word:"ใคร", en:"khrai", zh:"誰", level:"初", category:"สรรพนาม", syls:[{cons:"ค", cluster:"ร", vowel:"ใอ", tone_name:"สามัญ", th:"ใคร"}]},
  {word:"อะไร", readingTH:"อะ-ไร", en:"à-rai", zh:"什麼", level:"初", category:"สรรพนาม", syls:[{cons:"อ", vowel:"อะ", tone_name:"เอก", th:"อะ"}, {cons:"ร", vowel:"ไอ", tone_name:"สามัญ", th:"ไร"}]},
  {word:"ไหน", en:"nǎi", zh:"哪裡/哪個", level:"初", category:"สรรพนาม", syls:[{cons:"น", lead:"ห", vowel:"ไอ", tone_name:"จัตวา", th:"ไหน"}]},
  {word:"กัน", en:"gan", zh:"彼此/互相", level:"初", category:"สรรพนาม", syls:[{cons:"ก", vowel:"อะ", final:"น", tone_name:"สามัญ", th:"กัน"}]},
  {word:"ใน", en:"nai", zh:"在...裡面", level:"初", category:"บุพบท", syls:[{cons:"น", vowel:"ใอ", tone_name:"สามัญ", th:"ใน"}]},
  {word:"บน", en:"bon", zh:"在...上面", level:"初", category:"บุพบท", syls:[{cons:"บ", vowel:"โอะ", final:"น", tone_name:"สามัญ", th:"บน"}]},
  {word:"นอก", en:"nôok", zh:"在...外面", level:"初", category:"บุพบท", syls:[{cons:"น", vowel:"ออ", final:"ก", tone_name:"โท", th:"นอก"}]},
  {word:"ข้าง", en:"khâang", zh:"旁邊", level:"初", category:"บุพบท", syls:[{cons:"ข", vowel:"อา", tone:"้", final:"ง", tone_name:"โท", th:"ข้าง"}]},
  {word:"กลาง", en:"glaang", zh:"中間", level:"初", category:"บุพบท", syls:[{cons:"ก", cluster:"ล", vowel:"อา", final:"ง", tone_name:"สามัญ", th:"กลาง"}]},
  {word:"ระหว่าง", readingTH:"ระ-หว่าง", en:"rá-wàang", zh:"之間/期間", level:"中", category:"บุพบท", syls:[{cons:"ร", vowel:"อะ", tone_name:"ตรี", th:"ระ"}, {cons:"ว", lead:"ห", vowel:"อา", tone:"่", final:"ง", tone_name:"เอก", th:"หว่าง"}]},
  {word:"กับ", en:"gàp", zh:"跟/和", level:"初", category:"บุพบท", syls:[{cons:"ก", vowel:"อะ", final:"บ", tone_name:"เอก", th:"กับ"}]},
  {word:"จาก", en:"jàak", zh:"從", level:"初", category:"บุพบท", syls:[{cons:"จ", vowel:"อา", final:"ก", tone_name:"เอก", th:"จาก"}]},
  {word:"ถึง", en:"thěung", zh:"到/直到", level:"初", category:"บุพบท", syls:[{cons:"ถ", vowel:"อึ", final:"ง", tone_name:"จัตวา", th:"ถึง"}]},
  {word:"ตาม", en:"dtaam", zh:"沿著/按照", level:"初", category:"บุพบท", syls:[{cons:"ต", vowel:"อา", final:"ม", tone_name:"สามัญ", th:"ตาม"}]},
  {word:"สำหรับ", readingTH:"สำ-หรับ", en:"sǎm-ràp", zh:"為了", level:"中", category:"บุพบท", syls:[{cons:"ส", vowel:"อำ", tone_name:"จัตวา", th:"สำ"}, {cons:"ร", lead:"ห", vowel:"อะ", final:"บ", tone_name:"เอก", th:"หรับ"}]},
  {word:"ของ", en:"khǒong", zh:"的/屬於", level:"初", category:"บุพบท", syls:[{cons:"ข", vowel:"ออ", final:"ง", tone_name:"จัตวา", th:"ของ"}]},
  {word:"ต่อ", en:"dtòo", zh:"向/每/繼續", level:"初", category:"บุพบท", syls:[{cons:"ต", vowel:"ออ", tone:"่", tone_name:"เอก", th:"ต่อ"}]},
  {word:"เกี่ยวกับ", readingTH:"เกี่ยว-กับ", en:"gìao-gàp", zh:"關於", level:"中", category:"บุพบท", syls:[{cons:"ก", vowel:"เอีย", tone:"่", final:"ว", tone_name:"เอก", th:"เกี่ยว"}, {cons:"ก", vowel:"อะ", final:"บ", tone_name:"เอก", th:"กับ"}]},
  {word:"ก่อน", en:"gòon", zh:"在...之前", level:"初", category:"บุพบท", syls:[{cons:"ก", vowel:"ออ", tone:"่", final:"น", tone_name:"เอก", th:"ก่อน"}]},
  {word:"ท่ามกลาง", readingTH:"ท่าม-กลาง", en:"thâam-glaang", zh:"在...之中/當中", level:"中", category:"บุพบท", syls:[{cons:"ท", vowel:"อา", tone:"่", final:"ม", tone_name:"โท", th:"ท่าม"}, {cons:"ก", cluster:"ล", vowel:"อา", final:"ง", tone_name:"สามัญ", th:"กลาง"}]},
  {word:"และ", en:"láe", zh:"和/而且", level:"初", category:"สันธาน", syls:[{cons:"ล", vowel:"แอะ", tone_name:"ตรี", th:"และ"}]},
  {word:"หรือ", en:"rěu", zh:"或者", level:"初", category:"สันธาน", syls:[{cons:"ร", lead:"ห", vowel:"อือ", tone_name:"จัตวา", th:"หรือ"}]},
  {word:"แต่", en:"dtàe", zh:"但是", level:"初", category:"สันธาน", syls:[{cons:"ต", vowel:"แอ", tone:"่", tone_name:"เอก", th:"แต่"}]},
  {word:"เพราะ", en:"phráw", zh:"因為", level:"初", category:"สันธาน", syls:[{cons:"พ", cluster:"ร", vowel:"เอาะ", tone_name:"ตรี", th:"เพราะ"}]},
  {word:"ถ้า", en:"thâa", zh:"如果", level:"初", category:"สันธาน", syls:[{cons:"ถ", vowel:"อา", tone:"้", tone_name:"โท", th:"ถ้า"}]},
  {word:"เพื่อ", en:"phêua", zh:"為了", level:"初", category:"สันธาน", syls:[{cons:"พ", vowel:"เอือ", tone:"่", tone_name:"โท", th:"เพื่อ"}]},
  {word:"แล้ว", en:"láeo", zh:"然後/已經", level:"初", category:"สันธาน", syls:[{cons:"ล", vowel:"แอ", tone:"้", final:"ว", tone_name:"ตรี", th:"แล้ว"}]},
  {word:"ก็", en:"gôr", zh:"也/就", level:"初", category:"สันธาน", syls:[{cons:"ก", vowel:"เอาะ", tone_name:"โท", th:"ก็"}]},
  {word:"จึง", en:"jeung", zh:"於是/所以", level:"中", category:"สันธาน", syls:[{cons:"จ", vowel:"อึ", final:"ง", tone_name:"สามัญ", th:"จึง"}]},
  {word:"ดังนั้น", readingTH:"ดัง-นั้น", en:"dang-nán", zh:"因此/所以", level:"中", category:"สันธาน", syls:[{cons:"ด", vowel:"อะ", final:"ง", tone_name:"สามัญ", th:"ดัง"}, {cons:"น", vowel:"อะ", tone:"้", final:"น", tone_name:"ตรี", th:"นั้น"}]},
  {word:"เนื่องจาก", readingTH:"เนื่อง-จาก", en:"nêuang-jàak", zh:"由於/因為", level:"中", category:"สันธาน", syls:[{cons:"น", vowel:"เอือ", tone:"่", final:"ง", tone_name:"โท", th:"เนื่อง"}, {cons:"จ", vowel:"อา", final:"ก", tone_name:"เอก", th:"จาก"}]},
  {word:"แม้ว่า", readingTH:"แม้-ว่า", en:"máe-wâa", zh:"儘管/雖然", level:"中", category:"สันธาน", syls:[{cons:"ม", vowel:"แอ", tone:"้", tone_name:"ตรี", th:"แม้"}, {cons:"ว", vowel:"อา", tone:"่", tone_name:"โท", th:"ว่า"}]},
  {word:"ถึงแม้", readingTH:"ถึง-แม้", en:"thěung-máe", zh:"即使/雖然", level:"中", category:"สันธาน", syls:[{cons:"ถ", vowel:"อึ", final:"ง", tone_name:"จัตวา", th:"ถึง"}, {cons:"ม", vowel:"แอ", tone:"้", tone_name:"ตรี", th:"แม้"}]},
  {word:"หาก", en:"hàak", zh:"如果（正式）", level:"中", category:"สันธาน", syls:[{cons:"ห", vowel:"อา", final:"ก", tone_name:"เอก", th:"หาก"}]},
  {word:"จนกว่า", readingTH:"จน-กว่า", en:"jon-gwàa", zh:"直到", level:"中", category:"สันธาน", syls:[{cons:"จ", vowel:"อะ", final:"น", tone_name:"สามัญ", th:"จน"}, {cons:"ก", cluster:"ว", vowel:"อา", tone:"่", tone_name:"เอก", th:"กว่า"}]},
  {word:"ตั้งแต่", readingTH:"ตั้ง-แต่", en:"tâng-dtàe", zh:"自從/從...開始", level:"中", category:"สันธาน", syls:[{cons:"ต", vowel:"อะ", tone:"้", final:"ง", tone_name:"โท", th:"ตั้ง"}, {cons:"ต", vowel:"แอ", tone:"่", tone_name:"เอก", th:"แต่"}]},
  {word:"ขณะที่", readingTH:"ขะ-หนะ-ที่", en:"khà-nà-thîi", zh:"當...的時候", level:"中", category:"สันธาน", syls:[{cons:"ข", vowel:"อะ", tone_name:"เอก", th:"ข"}, {cons:"ณ", lead:"ห", vowel:"อะ", tone_name:"เอก", th:"ณะ", consRead:"น"}, {cons:"ท", vowel:"อี", tone:"่", tone_name:"โท", th:"ที่"}]},
  {word:"เมื่อ", en:"mêua", zh:"當...時候", level:"初", category:"สันธาน", syls:[{cons:"ม", vowel:"เอือ", tone:"่", tone_name:"โท", th:"เมื่อ"}]},
  {word:"เว้นแต่", readingTH:"เว้น-แต่", en:"wén-dtàe", zh:"除非/除了", level:"中", category:"สันธาน", syls:[{cons:"ว", vowel:"เอ", tone:"้", final:"น", tone_name:"ตรี", th:"เว้น"}, {cons:"ต", vowel:"แอ", tone:"่", tone_name:"เอก", th:"แต่"}]},
  {word:"ทั้งที่", readingTH:"ทั้ง-ที่", en:"tháng-thîi", zh:"儘管/雖然", level:"中", category:"สันธาน", syls:[{cons:"ท", vowel:"อะ", tone:"้", final:"ง", tone_name:"ตรี", th:"ทั้ง"}, {cons:"ท", vowel:"อี", tone:"่", tone_name:"โท", th:"ที่"}]},
  {word:"ใช่", en:"châi", zh:"是/對", level:"初", category:"คำอุทาน/สำนวน", syls:[{cons:"ช", vowel:"ใอ", tone:"่", tone_name:"โท", th:"ใช่"}]},
  {word:"ใช้", en:"chái", zh:"使用", level:"初", category:"กริยา", syls:[{cons:"ช", vowel:"ใอ", tone:"้", tone_name:"ตรี", th:"ใช้"}]},
  {word:"สะใภ้", readingTH:"สะ-ใพ้", en:"sà-phái", zh:"（姻親）媳婦/嫂子", level:"中", category:"นามคน", syls:[{cons:"ส", vowel:"อะ", tone_name:"เอก", th:"สะ"}, {cons:"ภ", vowel:"ใอ", tone:"้", tone_name:"ตรี", th:"ใภ้", consRead:"พ"}]},
  {word:"ใส", en:"sǎi", zh:"清澈/透明", level:"初", category:"คำขยาย", syls:[{cons:"ส", vowel:"ใอ", tone_name:"จัตวา", th:"ใส"}]},
  {word:"ใส่", en:"sài", zh:"穿/放入", level:"初", category:"กริยา", syls:[{cons:"ส", vowel:"ใอ", tone:"่", tone_name:"เอก", th:"ใส่"}]},
  {word:"ให้", en:"hâi", zh:"給", level:"初", category:"กริยา", syls:[{cons:"ห", vowel:"ใอ", tone:"้", tone_name:"โท", th:"ให้"}]},
  {word:"อย่า", en:"yàa", zh:"別/不要", level:"初", category:"กิริยานุเคราะห์", syls:[{cons:"ย", lead:"อ", vowel:"อา", tone:"่", tone_name:"เอก", th:"อย่า"}]},
  {word:"อย่าง", en:"yàang", zh:"種/樣（量詞）", level:"初", category:"ลักษณนาม", syls:[{cons:"ย", lead:"อ", vowel:"อา", tone:"่", final:"ง", tone_name:"เอก", th:"อย่าง"}]},
  {word:"อยาก", en:"yàak", zh:"想要", level:"初", category:"กิริยานุเคราะห์", syls:[{cons:"ย", lead:"อ", vowel:"อา", final:"ก", tone_name:"เอก", th:"อยาก"}]},
  // ─── คำกิริยา 100 คำ เพิ่ม 2026-07-31 (Lin อนุมัติแล้วในแชท "เช็ก ผ่านหมดแล้ว ใช้ได้เลย") ───
  {word:"หา", en:"hǎa", zh:"找", level:"初", category:"กริยา", syls:[{cons:"ห", vowel:"อา", tone_name:"จัตวา", th:"หา"}]},
  {word:"เจอ", en:"jer", zh:"遇到", level:"初", category:"กริยา", syls:[{cons:"จ", vowel:"เออ", tone_name:"สามัญ", th:"เจอ"}]},
  {word:"พบ", en:"phóp", zh:"遇見（正式）", level:"初", category:"กริยา", syls:[{cons:"พ", vowel:"โอะ", final:"บ", tone_name:"ตรี", th:"พบ"}]},
  {word:"รอ", en:"ror", zh:"等", level:"初", category:"กริยา", syls:[{cons:"ร", vowel:"ออ", tone_name:"สามัญ", th:"รอ"}]},
  {word:"รีบ", en:"rêep", zh:"趕快", level:"初", category:"กริยา", syls:[{cons:"ร", vowel:"อี", final:"บ", tone_name:"โท", th:"รีบ"}]},
  {word:"ช่วย", en:"chûai", zh:"幫忙", level:"初", category:"กริยา", syls:[{cons:"ช", vowel:"อัว", tone:"่", final:"ย", tone_name:"โท", th:"ช่วย"}]},
  {word:"ซ่อม", en:"sôom", zh:"修理", level:"初", category:"กริยา", syls:[{cons:"ซ", vowel:"ออ", tone:"่", final:"ม", tone_name:"โท", th:"ซ่อม"}]},
  {word:"สร้าง", readingTH:"ส้าง", spellingTH:"สร้าง", en:"sâang", zh:"建造", level:"初", category:"กริยา", syls:[{cons:"ส", vowel:"อา", tone:"้", final:"ง", silent:"ร", tone_name:"โท", th:"สร้าง"}]},
  {word:"เปลี่ยน", en:"bplìan", zh:"改變", level:"初", category:"กริยา", syls:[{cons:"ป", cluster:"ล", vowel:"เอีย", tone:"่", final:"น", tone_name:"เอก", th:"เปลี่ยน"}]},
  {word:"ย้าย", en:"yáai", zh:"搬/搬家", level:"初", category:"กริยา", syls:[{cons:"ย", vowel:"อา", tone:"้", final:"ย", tone_name:"ตรี", th:"ย้าย"}]},
  {word:"หยิบ", en:"yìp", zh:"拿/撿起", level:"初", category:"กริยา", syls:[{cons:"ย", lead:"ห", vowel:"อิ", final:"บ", tone_name:"เอก", th:"หยิบ"}]},
  {word:"วาง", en:"waang", zh:"放/放下", level:"初", category:"กริยา", syls:[{cons:"ว", vowel:"อา", final:"ง", tone_name:"สามัญ", th:"วาง"}]},
  {word:"ยก", en:"yók", zh:"舉/抬", level:"初", category:"กริยา", syls:[{cons:"ย", vowel:"โอะ", final:"ก", tone_name:"ตรี", th:"ยก"}]},
  {word:"ดึง", en:"dueng", zh:"拉", level:"初", category:"กริยา", syls:[{cons:"ด", vowel:"อึ", final:"ง", tone_name:"สามัญ", th:"ดึง"}]},
  {word:"ผลัก", en:"phlàk", zh:"推", level:"初", category:"กริยา", syls:[{cons:"ผ", cluster:"ล", vowel:"อะ", final:"ก", tone_name:"เอก", th:"ผลัก"}]},
  {word:"โยน", en:"yoon", zh:"丟/扔", level:"初", category:"กริยา", syls:[{cons:"ย", vowel:"โอ", final:"น", tone_name:"สามัญ", th:"โยน"}]},
  {word:"จับ", en:"jàp", zh:"抓/握", level:"初", category:"กริยา", syls:[{cons:"จ", vowel:"อะ", final:"บ", tone_name:"เอก", th:"จับ"}]},
  {word:"ปล่อย", en:"bplòi", zh:"放開/釋放", level:"初", category:"กริยา", syls:[{cons:"ป", cluster:"ล", vowel:"ออ", tone:"่", final:"ย", tone_name:"เอก", th:"ปล่อย"}]},
  {word:"เปิด", en:"bpèrt", zh:"開", level:"初", category:"กริยา", syls:[{cons:"ป", vowel:"เออ", final:"ด", tone_name:"เอก", th:"เปิด"}]},
  {word:"ปิด", en:"bpìt", zh:"關", level:"初", category:"กริยา", syls:[{cons:"ป", vowel:"อิ", final:"ด", tone_name:"เอก", th:"ปิด"}]},
  {word:"ล้าง", en:"láang", zh:"洗", level:"初", category:"กริยา", syls:[{cons:"ล", vowel:"อา", tone:"้", final:"ง", tone_name:"ตรี", th:"ล้าง"}]},
  {word:"ซัก", en:"sák", zh:"洗（布類）", level:"初", category:"กริยา", syls:[{cons:"ซ", vowel:"อะ", final:"ก", tone_name:"ตรี", th:"ซัก"}]},
  {word:"หุง", en:"hǔng", zh:"煮（飯）", level:"初", category:"กริยา", syls:[{cons:"ห", vowel:"อุ", final:"ง", tone_name:"จัตวา", th:"หุง"}]},
  {word:"ต้ม", en:"dtôm", zh:"煮/燉", level:"初", category:"กริยา", syls:[{cons:"ต", vowel:"โอะ", tone:"้", final:"ม", tone_name:"โท", th:"ต้ม"}]},
  {word:"ทอด", en:"thôot", zh:"炸", level:"初", category:"กริยา", syls:[{cons:"ท", vowel:"ออ", final:"ด", tone_name:"โท", th:"ทอด"}]},
  {word:"ผัด", en:"phàt", zh:"炒", level:"初", category:"กริยา", syls:[{cons:"ผ", vowel:"อะ", final:"ด", tone_name:"เอก", th:"ผัด"}]},
  {word:"นึ่ง", en:"nêung", zh:"蒸", level:"初", category:"กริยา", syls:[{cons:"น", vowel:"อึ", tone:"่", final:"ง", tone_name:"โท", th:"นึ่ง"}]},
  {word:"ปิ้ง", en:"bpîng", zh:"烤", level:"初", category:"กริยา", syls:[{cons:"ป", vowel:"อิ", tone:"้", final:"ง", tone_name:"โท", th:"ปิ้ง"}]},
  {word:"ย่าง", en:"yâang", zh:"烤", level:"初", category:"กริยา", syls:[{cons:"ย", vowel:"อา", tone:"่", final:"ง", tone_name:"โท", th:"ย่าง"}]},
  {word:"หั่น", en:"hàn", zh:"切", level:"初", category:"กริยา", syls:[{cons:"ห", vowel:"อะ", tone:"่", final:"น", tone_name:"เอก", th:"หั่น"}]},
  {word:"ปอก", en:"bpòok", zh:"剝皮", level:"初", category:"กริยา", syls:[{cons:"ป", vowel:"ออ", final:"ก", tone_name:"เอก", th:"ปอก"}]},
  {word:"คิด", en:"khít", zh:"想", level:"初", category:"กริยา", syls:[{cons:"ค", vowel:"อิ", final:"ด", tone_name:"ตรี", th:"คิด"}]},
  {word:"รู้", en:"rúu", zh:"知道", level:"初", category:"กริยา", syls:[{cons:"ร", vowel:"อู", tone:"้", tone_name:"ตรี", th:"รู้"}]},
  {word:"เข้าใจ", readingTH:"เข้า-ใจ", en:"khâo-jai", zh:"明白/了解", level:"初", category:"กริยา", syls:[{cons:"ข", vowel:"เอา", tone:"้", tone_name:"โท", th:"เข้า"}, {cons:"จ", vowel:"ใอ", tone_name:"สามัญ", th:"ใจ"}]},
  {word:"จำ", en:"jam", zh:"記得", level:"初", category:"กริยา", syls:[{cons:"จ", vowel:"อำ", tone_name:"สามัญ", th:"จำ"}]},
  {word:"ลืม", en:"leum", zh:"忘記", level:"初", category:"กริยา", syls:[{cons:"ล", vowel:"อื", final:"ม", tone_name:"สามัญ", th:"ลืม"}]},
  {word:"เชื่อ", en:"chêua", zh:"相信", level:"初", category:"กริยา", syls:[{cons:"ช", vowel:"เอือ", tone:"่", tone_name:"โท", th:"เชื่อ"}]},
  {word:"หวัง", en:"wǎng", zh:"希望", level:"初", category:"กริยา", syls:[{cons:"ว", lead:"ห", vowel:"อะ", final:"ง", tone_name:"จัตวา", th:"หวัง"}]},
  {word:"ฝัน", en:"fǎn", zh:"做夢", level:"初", category:"กริยา", syls:[{cons:"ฝ", vowel:"อะ", final:"น", tone_name:"จัตวา", th:"ฝัน"}]},
  {word:"กลัว", en:"glua", zh:"害怕", level:"初", category:"กริยา", syls:[{cons:"ก", cluster:"ล", vowel:"อัว", tone_name:"สามัญ", th:"กลัว"}]},
  {word:"ดีใจ", readingTH:"ดี-ใจ", en:"dii-jai", zh:"高興", level:"初", category:"กริยา", syls:[{cons:"ด", vowel:"อี", tone_name:"สามัญ", th:"ดี"}, {cons:"จ", vowel:"ใอ", tone_name:"สามัญ", th:"ใจ"}]},
  {word:"เสียใจ", readingTH:"เสีย-ใจ", en:"sǐa-jai", zh:"難過", level:"初", category:"กริยา", syls:[{cons:"ส", vowel:"เอีย", final:"ย", tone_name:"จัตวา", th:"เสีย"}, {cons:"จ", vowel:"ใอ", tone_name:"สามัญ", th:"ใจ"}]},
  {word:"ตกใจ", readingTH:"ตก-ใจ", en:"dtòk-jai", zh:"嚇一跳", level:"初", category:"กริยา", syls:[{cons:"ต", vowel:"โอะ", final:"ก", tone_name:"เอก", th:"ตก"}, {cons:"จ", vowel:"ใอ", tone_name:"สามัญ", th:"ใจ"}]},
  {word:"สงสัย", readingTH:"สง-สัย", en:"sǒng-sǎi", zh:"懷疑/納悶", level:"初", category:"กริยา", syls:[{cons:"ส", vowel:"โอะ", final:"ง", tone_name:"จัตวา", th:"สง"}, {cons:"ส", vowel:"อะ", final:"ย", tone_name:"จัตวา", th:"สัย"}]},
  {word:"ตัดสินใจ", readingTH:"ตัด-สิน-ใจ", en:"dtàt-sǐn-jai", zh:"決定", level:"中", category:"กริยา", syls:[{cons:"ต", vowel:"อะ", final:"ด", tone_name:"เอก", th:"ตัด"}, {cons:"ส", vowel:"อิ", final:"น", tone_name:"จัตวา", th:"สิน"}, {cons:"จ", vowel:"ใอ", tone_name:"สามัญ", th:"ใจ"}]},
  {word:"เลือก", en:"lêuak", zh:"選擇", level:"初", category:"กริยา", syls:[{cons:"ล", vowel:"เอือ", final:"ก", tone_name:"โท", th:"เลือก"}]},
  {word:"ลอง", en:"long", zh:"嘗試", level:"初", category:"กริยา", syls:[{cons:"ล", vowel:"ออ", final:"ง", tone_name:"สามัญ", th:"ลอง"}]},
  {word:"ฝึก", en:"fèuk", zh:"練習", level:"初", category:"กริยา", syls:[{cons:"ฝ", vowel:"อึ", final:"ก", tone_name:"เอก", th:"ฝึก"}]},
  {word:"เรียน", en:"rian", zh:"學習", level:"初", category:"กริยา", syls:[{cons:"ร", vowel:"เอีย", final:"น", tone_name:"สามัญ", th:"เรียน"}]},
  {word:"สอน", en:"sǒon", zh:"教", level:"初", category:"กริยา", syls:[{cons:"ส", vowel:"ออ", final:"น", tone_name:"จัตวา", th:"สอน"}]},
  {word:"ถาม", en:"thǎam", zh:"問", level:"初", category:"กริยา", syls:[{cons:"ถ", vowel:"อา", final:"ม", tone_name:"จัตวา", th:"ถาม"}]},
  {word:"ตอบ", en:"dtòop", zh:"回答", level:"初", category:"กริยา", syls:[{cons:"ต", vowel:"ออ", final:"บ", tone_name:"เอก", th:"ตอบ"}]},
  {word:"บอก", en:"bòok", zh:"告訴", level:"初", category:"กริยา", syls:[{cons:"บ", vowel:"ออ", final:"ก", tone_name:"เอก", th:"บอก"}]},
  {word:"อธิบาย", readingTH:"อะ-ธิ-บาย", spellingTH:"อ-ธิ-บาย", en:"à-thí-baai", zh:"解釋", level:"中", category:"กริยา", syls:[{cons:"อ", vowel:"อะ", tone_name:"เอก", th:"อ"}, {cons:"ธ", vowel:"อิ", tone_name:"ตรี", th:"ธิ"}, {cons:"บ", vowel:"อา", final:"ย", tone_name:"สามัญ", th:"บาย"}]},
  {word:"แปล", en:"bplae", zh:"翻譯", level:"初", category:"กริยา", syls:[{cons:"ป", cluster:"ล", vowel:"แอ", tone_name:"สามัญ", th:"แปล"}]},
  {word:"วาด", en:"wâat", zh:"畫", level:"初", category:"กริยา", syls:[{cons:"ว", vowel:"อา", final:"ด", tone_name:"โท", th:"วาด"}]},
  {word:"เต้น", en:"dtên", zh:"跳舞", level:"初", category:"กริยา", syls:[{cons:"ต", vowel:"เอ", tone:"้", final:"น", tone_name:"โท", th:"เต้น"}]},
  {word:"เล่น", en:"lên", zh:"玩", level:"初", category:"กริยา", syls:[{cons:"ล", vowel:"เอ", tone:"่", final:"น", tone_name:"โท", th:"เล่น"}]},
  {word:"ทำงาน", readingTH:"ทำ-งาน", en:"tham-ngaan", zh:"工作", level:"初", category:"กริยา", syls:[{cons:"ท", vowel:"อำ", tone_name:"สามัญ", th:"ทำ"}, {cons:"ง", vowel:"อา", final:"น", tone_name:"สามัญ", th:"งาน"}]},
  {word:"พัก", en:"phák", zh:"休息", level:"初", category:"กริยา", syls:[{cons:"พ", vowel:"อะ", final:"ก", tone_name:"ตรี", th:"พัก"}]},
  {word:"พักผ่อน", readingTH:"พัก-ผ่อน", en:"phák-phòn", zh:"放鬆/休息", level:"初", category:"กริยา", syls:[{cons:"พ", vowel:"อะ", final:"ก", tone_name:"ตรี", th:"พัก"}, {cons:"ผ", vowel:"ออ", tone:"่", final:"น", tone_name:"เอก", th:"ผ่อน"}]},
  {word:"อาบน้ำ", readingTH:"อาบ-น้ำ", en:"àap-náam", zh:"洗澡", level:"初", category:"กริยา", syls:[{cons:"อ", vowel:"อา", final:"บ", tone_name:"เอก", th:"อาบ"}, {cons:"น", vowel:"อำ", tone:"้", tone_name:"ตรี", th:"น้ำ"}]},
  {word:"แปรงฟัน", readingTH:"แปรง-ฟัน", en:"bpraeng-fan", zh:"刷牙", level:"初", category:"กริยา", syls:[{cons:"ป", cluster:"ร", vowel:"แอ", final:"ง", tone_name:"สามัญ", th:"แปรง"}, {cons:"ฟ", vowel:"อะ", final:"น", tone_name:"สามัญ", th:"ฟัน"}]},
  {word:"หวี", en:"wǐi", zh:"梳（頭）", level:"初", category:"กริยา", syls:[{cons:"ว", lead:"ห", vowel:"อี", tone_name:"จัตวา", th:"หวี"}]},
  {word:"แต่งตัว", readingTH:"แต่ง-ตัว", en:"dtàeng-dtua", zh:"打扮/穿衣", level:"初", category:"กริยา", syls:[{cons:"ต", vowel:"แอ", tone:"่", final:"ง", tone_name:"เอก", th:"แต่ง"}, {cons:"ต", vowel:"อัว", tone_name:"สามัญ", th:"ตัว"}]},
  {word:"ถอด", en:"thòot", zh:"脫（衣服）", level:"初", category:"กริยา", syls:[{cons:"ถ", vowel:"ออ", final:"ด", tone_name:"เอก", th:"ถอด"}]},
  {word:"ขาย", en:"khǎai", zh:"賣", level:"初", category:"กริยา", syls:[{cons:"ข", vowel:"อา", final:"ย", tone_name:"จัตวา", th:"ขาย"}]},
  {word:"จ่าย", en:"jàai", zh:"付（錢）", level:"初", category:"กริยา", syls:[{cons:"จ", vowel:"อา", tone:"่", final:"ย", tone_name:"เอก", th:"จ่าย"}]},
  {word:"จอง", en:"joong", zh:"預訂", level:"初", category:"กริยา", syls:[{cons:"จ", vowel:"ออ", final:"ง", tone_name:"สามัญ", th:"จอง"}]},
  {word:"ยืม", en:"yeum", zh:"借", level:"初", category:"กริยา", syls:[{cons:"ย", vowel:"อื", final:"ม", tone_name:"สามัญ", th:"ยืม"}]},
  {word:"คืน", en:"kheun", zh:"歸還", level:"初", category:"กริยา", syls:[{cons:"ค", vowel:"อื", final:"น", tone_name:"สามัญ", th:"คืน"}]},
  {word:"แลก", en:"lâek", zh:"交換", level:"初", category:"กริยา", syls:[{cons:"ล", vowel:"แอ", final:"ก", tone_name:"โท", th:"แลก"}]},
  {word:"ส่ง", en:"sòng", zh:"送/寄", level:"初", category:"กริยา", syls:[{cons:"ส", vowel:"โอะ", tone:"่", final:"ง", tone_name:"เอก", th:"ส่ง"}]},
  {word:"รับ", en:"ráp", zh:"收/接", level:"初", category:"กริยา", syls:[{cons:"ร", vowel:"อะ", final:"บ", tone_name:"ตรี", th:"รับ"}]},
  {word:"เก็บ", en:"gèp", zh:"收拾/收集", level:"初", category:"กริยา", syls:[{cons:"ก", vowel:"เอะ", final:"บ", tone_name:"เอก", th:"เก็บ"}]},
  {word:"ทำความสะอาด", readingTH:"ทำ-ความ-สะ-อาด", en:"tham-khwaam-sà-àat", zh:"打掃", level:"初", category:"กริยา", syls:[{cons:"ท", vowel:"อำ", tone_name:"สามัญ", th:"ทำ"}, {cons:"ค", cluster:"ว", vowel:"อา", final:"ม", tone_name:"สามัญ", th:"ความ"}, {cons:"ส", vowel:"อะ", tone_name:"เอก", th:"สะ"}, {cons:"อ", vowel:"อา", final:"ด", tone_name:"เอก", th:"อาด"}]},
  {word:"กวาด", en:"gwàat", zh:"掃", level:"初", category:"กริยา", syls:[{cons:"ก", cluster:"ว", vowel:"อา", final:"ด", tone_name:"เอก", th:"กวาด"}]},
  {word:"ถู", en:"thǔu", zh:"擦/拖（地）", level:"初", category:"กริยา", syls:[{cons:"ถ", vowel:"อู", tone_name:"จัตวา", th:"ถู"}]},
  {word:"ล้างจาน", readingTH:"ล้าง-จาน", en:"láang-jaan", zh:"洗碗", level:"初", category:"กริยา", syls:[{cons:"ล", vowel:"อา", tone:"้", final:"ง", tone_name:"ตรี", th:"ล้าง"}, {cons:"จ", vowel:"อา", final:"น", tone_name:"สามัญ", th:"จาน"}]},
  {word:"วิ่ง", en:"wîng", zh:"跑", level:"初", category:"กริยา", syls:[{cons:"ว", vowel:"อิ", tone:"่", final:"ง", tone_name:"โท", th:"วิ่ง"}]},
  {word:"เดิน", en:"dern", zh:"走路", level:"初", category:"กริยา", syls:[{cons:"ด", vowel:"เออ", final:"น", tone_name:"สามัญ", th:"เดิน"}]},
  {word:"นั่ง", en:"nâng", zh:"坐", level:"初", category:"กริยา", syls:[{cons:"น", vowel:"อะ", tone:"่", final:"ง", tone_name:"โท", th:"นั่ง"}]},
  {word:"ยืน", en:"yeun", zh:"站", level:"初", category:"กริยา", syls:[{cons:"ย", vowel:"อื", final:"น", tone_name:"สามัญ", th:"ยืน"}]},
  {word:"กระโดด", readingTH:"กระ-โดด", en:"grà-dòot", zh:"跳", level:"初", category:"กริยา", syls:[{cons:"ก", cluster:"ร", vowel:"อะ", tone_name:"เอก", th:"กระ"}, {cons:"ด", vowel:"โอ", final:"ด", tone_name:"เอก", th:"โดด"}]},
  {word:"ว่ายน้ำ", readingTH:"ว่าย-น้ำ", en:"wâai-náam", zh:"游泳", level:"初", category:"กริยา", syls:[{cons:"ว", vowel:"อา", tone:"่", final:"ย", tone_name:"โท", th:"ว่าย"}, {cons:"น", vowel:"อำ", tone:"้", tone_name:"ตรี", th:"น้ำ"}]},
  {word:"ขับ", en:"khàp", zh:"開（車）", level:"初", category:"กริยา", syls:[{cons:"ข", vowel:"อะ", final:"บ", tone_name:"เอก", th:"ขับ"}]},
  {word:"ขี่", en:"khìi", zh:"騎", level:"初", category:"กริยา", syls:[{cons:"ข", vowel:"อี", tone:"่", tone_name:"เอก", th:"ขี่"}]},
  {word:"บิน", en:"bin", zh:"飛", level:"初", category:"กริยา", syls:[{cons:"บ", vowel:"อิ", final:"น", tone_name:"สามัญ", th:"บิน"}]},
  {word:"หยุด", en:"yùt", zh:"停", level:"初", category:"กริยา", syls:[{cons:"ย", lead:"ห", vowel:"อุ", final:"ด", tone_name:"เอก", th:"หยุด"}]},
  {word:"พิมพ์", readingTH:"พิม", spellingTH:"พิมพ์", en:"phim", zh:"打字", level:"初", category:"กริยา", syls:[{cons:"พ", vowel:"อิ", final:"ม", silent:"พ์", tone_name:"สามัญ", th:"พิมพ์"}]},
  {word:"กด", en:"gòt", zh:"按", level:"初", category:"กริยา", syls:[{cons:"ก", vowel:"โอะ", final:"ด", tone_name:"เอก", th:"กด"}]},
  {word:"โทร", readingTH:"โท", spellingTH:"โทร", en:"thoo", zh:"打電話", level:"初", category:"กริยา", syls:[{cons:"ท", vowel:"โอ", silent:"ร", tone_name:"สามัญ", th:"โทร"}]},
  {word:"แชท", readingTH:"แชด", spellingTH:"แชท", en:"cháet", zh:"聊天（打字）", level:"初", category:"กริยา", syls:[{cons:"ช", vowel:"แอ", final:"ท", finalRead:"ด", tone_name:"ตรี", th:"แชท"}]},
  {word:"นัด", en:"nát", zh:"約（時間）", level:"初", category:"กริยา", syls:[{cons:"น", vowel:"อะ", final:"ด", tone_name:"ตรี", th:"นัด"}]},
  {word:"ยิ้ม", en:"yím", zh:"微笑", level:"初", category:"กริยา", syls:[{cons:"ย", vowel:"อิ", tone:"้", final:"ม", tone_name:"ตรี", th:"ยิ้ม"}]},
  {word:"ร้องไห้", readingTH:"ร้อง-ไห้", en:"róong-hâi", zh:"哭", level:"初", category:"กริยา", syls:[{cons:"ร", vowel:"ออ", tone:"้", final:"ง", tone_name:"ตรี", th:"ร้อง"}, {cons:"ห", vowel:"ไอ", tone:"้", tone_name:"โท", th:"ไห้"}]},
  ...
  // อันดับ 1-91: ความถี่จริง (OpenSubtitles + TNC fallback) เหมือนเดิม
  // อันดับ 92-114: คำ中ที่ Lin เพิ่มเข้ามาทีหลัง (ยังไม่มีข้อมูลความถี่จริงรองรับ) เรียงตามลำดับที่ Lin เพิ่มในไฟล์ — ล็อกไว้ตายตัว 2026-07-31
  // 🔒 กฎโควตา (Lin ยืนยัน 2026-07-31): อันดับ 1-50 = โควตาคนไม่ล็อกอิน · 1-100 = โควตาคนล็อกอิน(ยังไม่จ่ายเงิน) · 101-114 = กันไว้สำหรับคนจ่ายเงินในอนาคต (ยังไม่มีระบบสมาชิกจ่ายเงินจริง จึงยังไม่มีใครเข้าถึงช่วงนี้ได้เลยตอนนี้)
  var CAP_ORDER_TH_中 = [
    ...
    "สวนสัตว์","สระผม","โกนหนวด","แต่งหน้า","ทะเลาะ","แนะนำ","ติดต่อ","ประกาศ","สัญญา","อิจฉา",
    "ภูมิใจ","ผิดหวัง","ตื่นเต้น","มั่นใจ","ไว้ใจ","สงสาร","ปฏิเสธ","ค้นคว้า","สรุป","สัมผัส",
...
(function (global) {
  ...
  global.buildWordListForToneFinder = function (master) {
    return master.map(function (w) {
      return {
        ...
        category: w.category,
        syls: w.syls,
        readSyls: w.readSyls // 2026-07-30: การแตกเสียงตามพยางค์อ่าน (4 คำที่พยางค์เขียน≠อ่าน) — หน้าเฉลยใช้ตัวนี้ก่อนถ้ามี
      };
    });
  };
  ...
  global.buildWordsForPhonicsGames = function (master) {
    return master.map(function (w) {
      ...
      ['cons', 'lead', 'cluster', 'vowel', 'tone', 'final', 'tone_name', 'syls', 'readingTH', 'readSyls'].forEach(function (f) { // 2026-07-30: เพิ่ม readSyls (เฉลยตามพยางค์อ่าน)
