...
(function (global) {
  ...
  {word:'ญาติ', readingTH:'ยาด', en:'yâat', zh:'親戚', level:'初', category:'นามคน', syls:[{cons:'ญ', vowel:'อา', final:'ต', tone_name:'โท', th:'ญาติ'}]},
  ...
  {word:'เช็คเอาท์', readingTH:'เช็ค-เอา', en:'chék-áo', zh:'退房', level:'中', category:'โรงแรม', syls:[{cons:'ช', vowel:'เอะ', final:'ค', tone_name:'ตรี', th:'เช็ค'}, {cons:'อ', vowel:'เอา', tone_name:'ตรี', th:'เอาท์'}]},
  ...
  {word:'สัมภาษณ์', readingTH:'สำ-พาด', en:'sǎm-phâat', zh:'面試', level:'中', category:'งาน', syls:[{cons:'ส', vowel:'อะ', final:'ม', tone_name:'จัตวา', th:'สัม'}, {cons:'ภ', vowel:'อา', final:'ษ', tone_name:'โท', th:'ภาษณ์'}]},
  ...
  {word:'นามบัตร', readingTH:'นาม-บัด', en:'naam-bàt', zh:'名片', level:'中', category:'งาน', syls:[{cons:'น', vowel:'อา', final:'ม', tone_name:'สามัญ', th:'นาม'}, {cons:'บ', vowel:'อะ', final:'ต', tone_name:'เอก', th:'บัตร'}]},
  ...
  {word:'ของขวัญ', readingTH:'ของ-ขวัน', en:'khǒong-khwǎn', zh:'禮物', level:'中', category:'ช้อปปิ้ง', syls:[{cons:'ข', vowel:'ออ', final:'ง', tone_name:'จัตวา', th:'ของ'}, {cons:'ข', cluster:'ว', vowel:'อะ', final:'ญ', tone_name:'จัตวา', th:'ขวัญ'}]},
  ...
  {word:'นาฬิกา', readingTH:'นา-ลิ-กา', en:'naa-lí-gaa', zh:'時鐘', level:'中', category:'เวลา', syls:[{cons:'น', vowel:'อา', tone_name:'สามัญ', th:'นา'}, {cons:'ฬ', vowel:'อิ', tone_name:'ตรี', th:'ฬิ'}, {cons:'ก', vowel:'อา', tone_name:'สามัญ', th:'กา'}]},
  ...
  {word:'ภาษา', readingTH:'พา-สา', en:'phaa-sǎa', zh:'語言', level:'中', category:'ทักทาย/เวลา/แนวคิด', syls:[{cons:'ภ', vowel:'อา', tone_name:'สามัญ', th:'ภา'}, {cons:'ษ', vowel:'อา', tone_name:'จัตวา', th:'ษา'}]},
