...
check('all Core 5 games load the recorder before the countdown-free shared flow', ['tone-finder.html','reading-game.html','listening-game.html','typing-game.html','word-order.html'].every((name) => {
  const html = read(name);
  return /practice-events\.js\?v=3[\s\S]*game-flow\.js\?v=11/.test(html);
}));
