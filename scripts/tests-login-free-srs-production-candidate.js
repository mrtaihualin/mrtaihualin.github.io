...
check(read('tone-finder.html').indexOf('tone-finder-game.min.js?v=101') !== -1, 'Tone fetches the current game runtime');
check(read('reading-game.html').indexOf('reading-game-app.min.js?v=64') !== -1, 'Reading fetches the current game runtime');
check(read('typing-game.html').indexOf('typing-game-app.min.js?v=62') !== -1, 'Typing fetches the current game runtime');
check(read('word-order.html').indexOf('word-order-app.min.js?v=47') !== -1, 'Word Order fetches the current game runtime');
