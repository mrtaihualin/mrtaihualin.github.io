...
pages.forEach(function (file) {
  var html = read(file);
  check(html.indexOf('js/core/minimum-guest-launch.js?v=16') !== -1, file + ' fetches the current Login Free launch gate');
...
check(read('js/core/minimum-guest-launch.js').indexOf('login-surface.js?v=11') !== -1, 'SRS pages fetch the account-aware Login surface');
