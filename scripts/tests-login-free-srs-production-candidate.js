...
check(read('tone-finder.html').indexOf('tone-finder-game.min.js?v=102') !== -1, 'Tone fetches the current game runtime');
check(read('reading-game.html').indexOf('reading-game-app.min.js?v=65') !== -1, 'Reading fetches the current game runtime');
check(read('typing-game.html').indexOf('typing-game-app.min.js?v=63') !== -1, 'Typing fetches the current game runtime');
