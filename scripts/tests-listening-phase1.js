...
check('Listening loads the approved Login Free owners', /reading-auth\.js\?v=32/.test(html) && /game-account\.js\?v=6/.test(html) && /practice-events\.js\?v=3/.test(html) && /tone-server\.js\?v=6/.test(html) && /learning-review\.js\?v=1/.test(html) && /typing-score\.js\?v=1/.test(html) && /listening-score\.js\?v=1/.test(html));
