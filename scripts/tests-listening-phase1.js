...
check('Listening exposes isolated Login Core, parks score server and keeps shared Guest score before app boot', /reading-auth\.js\?v=29/.test(html) && !/tone-server\.js/.test(html) && /typing-score\.js\?v=1/.test(html) && /listening-score\.js\?v=1/.test(html));
