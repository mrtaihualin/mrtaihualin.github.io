...
const tiered = [
  ...
  },
  {
    ...
    boot: /GameContentLoader\.boot\(\['js\/games\/reading-game-app\.min\.js\?v=65'\], \{game:'reading'\}\)/,
    resume: /GameResume\.save\(RG_RESUME_ID/,
  },
  {
    page: 'typing-game.html', game: 'typing', app: 'js/games/typing-game-app.js',
    boot: /GameContentLoader\.boot\(\['js\/games\/typing-game-app\.min\.js\?v=63'\], \{game:'typing'\}\)/,
