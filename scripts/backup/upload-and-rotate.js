...
async function uploadAndRotate({ drive, filePath, folderId, retentionDays, now = Date.now(), logger = console }) {
...
async function main() {
  ...
  await uploadAndRotate({ drive, filePath, folderId, retentionDays });
}
